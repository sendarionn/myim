...
- 「TKGJE基本辞書を使用」で基本辞書候補と動詞活用候補をオン・オフ
...
- `kakujuu`から`拡充`が出ないような基本辞書の不足を検出
- 読みと表記を持つ追加辞書を導入し、TKGJEを補完
- 不足例を回帰テストへ追加し、辞書更新後も候補を維持
- ユーザー辞書、Cosense拡張辞書、既存の基本候補を優先
